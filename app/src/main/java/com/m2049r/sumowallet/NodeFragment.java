        ...
        pullToRefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                if (WalletManager.getInstance().getNetworkType() == NetworkType.NetworkType_Mainnet) {
                    refresh();
                    Toast.makeText(getActivity(), getString(R.string.node_refresh_wait), Toast.LENGTH_LONG).show();
                } else {
    ...
    private class AsyncFindNodes extends AsyncTask<Void, NodeInfo, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            if ((d.getRpcNodes().size() < NODES_TO_FIND) &&
                ...
                // also seed with sumokoin seed nodes (see p2p/net_node.inl:618 in sumokoin src)
                ...
                seedList.add(new NodeInfo(new InetSocketAddress("157.230.187.169", 19733))); //New York 1
                seedList.add(new NodeInfo(new InetSocketAddress("157.245.14.220", 19733))); //New York 2
                seedList.add(new NodeInfo(new InetSocketAddress("134.209.109.190", 19733))); //Singapore 2
                seedList.add(new NodeInfo(new InetSocketAddress("167.172.44.84", 19733))); //Amsterdam
